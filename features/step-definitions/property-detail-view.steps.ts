...
When("I select the first property from the results", async function (this: CustomWorld) {
    const viewDetailsButton = this.page.getByRole("button", { name: /view details/i }).first();
